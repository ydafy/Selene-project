...
Provide a skip link so keyboard users can bypass repetitive navigation. See the [skip link pattern](../accessibility/references/A11Y-PATTERNS.md.md#skip-link) for full markup and styles.
