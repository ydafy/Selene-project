...
> The user discarded/removed this module from the repository. Checked boxes below indicate archive closure/cancellation, not proof that unfinished work was implemented.
...
**Acceptance**:
- [x] Cancelled: Migration runs without errors — module discarded; not implemented as active feature
- [x] Cancelled: `payout_requests.status` only accepts enum values — module discarded; not implemented as active feature
- [x] Cancelled: View returns joined data for admin users — module discarded; not implemented as active feature
- [x] Cancelled: Non-admin users get 0 rows from view — module discarded; not implemented as active feature
- [x] Cancelled: `completed_at`, `rejected_reason`, `rejected_at` columns exist on `payout_requests` — module discarded; not implemented as active feature
...
**Acceptance**:
- [x] Cancelled: `PayoutOverviewRow` type exists with all view columns — module discarded; not implemented as active feature
- [x] Cancelled: `PayoutStatus` type is `'pending' | 'processing' | 'completed' | 'rejected'` — module discarded; not implemented as active feature
- [x] Cancelled: No TypeScript errors in the project — module discarded; not implemented as active feature
...
**Acceptance**:
- [x] Cancelled: All 4 PAY-004 scenarios pass — module discarded; not implemented as active feature
- [x] Cancelled: Edge case: empty string returns `{ valid: false, error: "CLABE debe tener 18 dígitos" }` — module discarded; not implemented as active feature
- [x] Cancelled: `bun test validateCLABE.test.ts` passes — module discarded; not implemented as active feature
...
**Acceptance**:
- [x] Cancelled: All 3 PAY-005 scenarios pass — module discarded; not implemented as active feature
- [x] Cancelled: "María Muñoz García" → "MARIA MUNOZ GARCIA" — module discarded; not implemented as active feature
- [x] Cancelled: "José #1 & Co." → "JOSE 1 CO" — module discarded; not implemented as active feature
- [x] Cancelled: null → "" — module discarded; not implemented as active feature
- [x] Cancelled: `bun test sanitizeBBVAName.test.ts` passes — module discarded; not implemented as active feature
...
**Acceptance**:
- [x] Cancelled: All 3 PAY-006 scenarios pass — module discarded; not implemented as active feature
- [x] Cancelled: `"BBVA México"` → `"012"` (leading zero preserved) — module discarded; not implemented as active feature
- [x] Cancelled: `"Banorte / IXE"` → `"072"` (not `"72"`) — module discarded; not implemented as active feature
- [x] Cancelled: `"Unknown Bank"` throws with bank name in message — module discarded; not implemented as active feature
- [x] Cancelled: `bun test bankCodes.test.ts` passes — module discarded; not implemented as active feature
...
**Acceptance**:
- [x] Cancelled: Pre-export modal shows validation results — module discarded; not implemented as active feature
- [x] Cancelled: DB update happens BEFORE file download — module discarded; not implemented as active feature
- [x] Cancelled: Race condition: 0 affected rows shows warning, continues with valid rows — module discarded; not implemented as active feature
- [x] Cancelled: Failed download: admin can re-generate — module discarded; not implemented as active feature
- [x] Cancelled: "Re-generar Archivo" works for processing payouts — module discarded; not implemented as active feature
- [x] Cancelled: Audit log entries created for all actions — module discarded; not implemented as active feature
- [x] Cancelled: CLABE values never appear in audit JSON — module discarded; not implemented as active feature
...
**Acceptance**:
- [x] Cancelled: All 4 transitions work with confirmation modals — module discarded; not implemented as active feature
- [x] Cancelled: Reject requires reason (min 5 chars) via InputModal — module discarded; not implemented as active feature
- [x] Cancelled: Rejected payout restores wallet balance — module discarded; not implemented as active feature
- [x] Cancelled: All transitions logged to admin_audit_logs — module discarded; not implemented as active feature
- [x] Cancelled: Invalid transitions blocked (e.g., pending → completed directly) — module discarded; not implemented as active feature
...
- [x] Cancelled: All monetary values in UserPayoutsTable use formatCurrency() — module discarded; not implemented as active feature
