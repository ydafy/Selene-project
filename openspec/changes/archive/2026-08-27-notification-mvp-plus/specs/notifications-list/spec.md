...
(Previously: Screen used split hooks for list and mark-as-read actions only.)
...
- Adds CONF-101 (dismiss item), CONF-102 (clear-all), CONF-103 (count badge), and CONF-104 (accessibility labels).
- Modifies the screen-integration requirement to include `dismissNotification` and `dismissAll`.
