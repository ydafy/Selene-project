...
export const DashboardHome = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold">Resumen Operativo</h1>
      ...
      {!isError && (
        <>
          ...
          {/* ── Strategic Metrics ── */}
          <div>
            <h3 className="text-lg font-bold text-platinum mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-state-gray p-6 rounded-2xl border border-white/5">
            <h3 className="text-sm font-bold text-platinum uppercase tracking-widest flex items-center gap-2 mb-4">
              <Activity size={14} className="text-blue-light" /> Resumen de
              Actividad
            </h3>
            {isLoading ? (
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-white/5">
                  ...
                  <span className="text-lion font-semibold">
