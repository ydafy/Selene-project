...
export const IntelIcon = (props: SvgProps) => (
  <Svg viewBox="0 0 512 512" width="100%" height="100%" fill="none" {...props}>
    {/* He quitado el <Rect> de fondo blanco para que se vea integrado y profesional */}
    <Path
      fill="#0071c5"
